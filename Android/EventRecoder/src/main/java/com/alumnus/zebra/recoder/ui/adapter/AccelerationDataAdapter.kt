package com.alumnus.zebra.recoder.ui.adapter
...
import com.alumnus.zebra.recoder.R
import com.alumnus.zebra.recoder.pojo.AccelerationStringData
import java.util.*
 ...
 * @author Arnab Kundu
 */
class AccelerationDataAdapter(private val accelerations: ArrayList<AccelerationStringData>) :
    RecyclerView.Adapter<AccelerationDataAdapter.ViewHolder>() {
